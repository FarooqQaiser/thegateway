  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <main id="main" class="main">
        ...
        <table class="table">
            ...
            <tbody>
            <?php
                $query = "SELECT mockTestReg_id, fullName , phoneNumber FROM mocktest_reg ";
                    ...
                    foreach($result as $row)
                    {
                         ?>
                            <tr>
                                  ...
                                  <td><a href="mockdetails.php?mockTestReg_id=<?= $row->mockTestReg_id; ?>"><i class="bi bi-arrow-right"></i>More Details</a></td>
                            </tr>
                         <?php
                    }
                }

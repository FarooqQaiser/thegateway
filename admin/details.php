...
if (isset($_GET['personal_id'])) {
  $_SESSION['personal_id'] = $_GET['personal_id'];
}
?>
        ...
        <div class="container rounded bg-white mt-5 mb-5">
            <div class="row">
                 ...
                 <div class="right-div">
                   <div class="d-flex justify-content-center align-items-center h-100">
                     <table class="table">
                       <tbody>
                       <?php
                              $query = "SELECT fullName, fatherName, phone, email, cnic, city, reference
                              FROM personal_details 
                              WHERE personal_id = :personal_id";
                             $statement = $conn->prepare($query);
                             $statement->bindParam(':personal_id', $_SESSION['personal_id']);
                             $statement->execute();
                ...
                <table class="table">
                    ...
                    <?php
                $query = "SELECT p.personal_id, p.fullName, p.phone, a.academic_id, a.degreeName, a.grade, a.year, a.university
                FROM personal_details p
                INNER JOIN academic_details a ON p.personal_id = a.personal_id
                ...
                <table class="table">
                    ...
                    <tbody class="table-group-divider">
                    <?php
                $query = "SELECT p.personal_id, p.fullName, p.phone, a.professional_id, a.organizationName, a.designation, a.period 
                FROM personal_details p
                INNER JOIN professional_details a ON p.personal_id = a.personal_id
                WHERE p.personal_id = :personal_id";

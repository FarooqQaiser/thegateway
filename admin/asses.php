  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Assesment Forms</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <table class="table">
            ...
            <tbody>
            <?php
                $query = "SELECT personal_id, fullName , phone FROM personal_details ";
                    ...
                    foreach($result as $row)
                    {
                         ?>
                            <tr>
                                  ...
                                  <td><?= $row->fullName; ?></td>
                                  <td><?= $row->phone; ?></td>
                                  <td><a href="details.php?personal_id=<?= $row->personal_id; ?>"><i class="bi bi-arrow-right"></i>More Details</a></td>
                            </tr>
                         <?php
                    }
                }

  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <main id="main" class="main">
        ...
        <table class="table">
            ...
            <tbody>
            <?php
                $query = "SELECT consultantForm_id, fullName , phone FROM consultantform ";
                ...
                {       
                    foreach($result as $row)
                    {
                         ?>
                            <tr>
                                  <td hidden><?= $row->consultantForm_id; ?></td>
                                  <td><?= $row->fullName; ?></td>
                                  <td><?= $row->phone; ?></td>
                                  <td><a href="consuldetails.php?consultantForm_id=<?= $row->consultantForm_id; ?>"><i class="bi bi-arrow-right"></i>More Details</a></td>
                            </tr>
                         <?php
                    }
                }

...
if (isset($_GET['consultantForm_id'])) {
  $_SESSION['consultantForm_id'] = $_GET['consultantForm_id'];
}
?>
                   ...
                   <div class="d-flex justify-content-center align-items-center h-100">
                     <table class="table">
                       ...
                       <?php
                              ...
                              FROM consultantform
                              WHERE consultantForm_id  = :consultantForm_id ";
                             $statement = $conn->prepare($query);
                             $statement->bindParam(':consultantForm_id', $_SESSION['consultantForm_id']);
